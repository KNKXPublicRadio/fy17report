...
```
* * * * * ubuntu bash /home/ubuntu/apps/fy17report/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|fy17report|tweet|`location`||
|fy17report|facebook|`location`||
|fy17report|email|`location`||
|fy17report|new-comment||
|fy17report|open-share-discuss||
|fy17report|close-share-discuss||
|fy17report|summary-copied||
|fy17report|featured-tweet-action|`action`|
|fy17report|featured-facebook-action|`action`|
