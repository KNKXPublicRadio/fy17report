...
PROJECT_SLUG = 'fy17report'

# Project name to be used in file paths
PROJECT_FILENAME = 'fy17report'

# The name of the repository containing the source
REPOSITORY_NAME = 'fy17report'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '1L7qgCHkhK8jQxxljpQHTamrr9zC9QPXUNdM8nEbN-vU'
